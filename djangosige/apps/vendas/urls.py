...
urlpatterns = [
    ...
    path('orcamentovenda/editar/(?P<pk>[0-9]+)/$',
    ...
    path('pedidovenda/editar/(?P<pk>[0-9]+)/$',
    ...
    path('pagamento/editar/(?P<pk>[0-9]+)/$', views.EditarCondicaoPagamentoView.as_view(
